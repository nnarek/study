...
Proof.
  ...
  -reflexivity.
  -rewrite (eqb_neq x x) in H. unfold not in H. destruct H. reflexivity. 
Qed.
(** [] *)
...
Proof.
  intros.
  unfold "x '!->' v ';' m".
  destruct (x1 =? x2)%string eqn:He.
  -apply eqb_eq in He. apply H in He. destruct He.
  -reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  intros.
  destruct (x =? x0)%string eqn:He.
  -apply eqb_eq in He. rewrite He. reflexivity.
  -reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  apply functional_extensionality.
  intros.
  destruct (x1 =? x)%string eqn:He.
  -apply eqb_eq in He. rewrite <- He. apply eqb_neq in H. rewrite H. reflexivity.
  -destruct (x2 =? x)%string.
    +reflexivity.
    +reflexivity.
Qed.
(** [] *)
