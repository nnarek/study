...
(*********
(*TODO check properties against generalized case*)
--algorithm 1BitMutex {
...
*********)
\* BEGIN TRANSLATION (chksum(pcal) = "d8088c1e" /\ chksum(tla) = "59f82434")
VARIABLES pc, flag
...
\* Last modified Tue Mar 25 19:10:49 GET 2025 by developer
