...
(synth-fun max2 ((x Int) (y Int)) Int
    ...
    ;; production rules for return value should be declared first(in this case it is 'I') 
    (
        ;; 'I' can be one of 'x' 'y' '0' '1' 'I+I' 'I-I' 'ite B I I' (all these functions are already defined)
        (I Int (x y 0 1
             (+ I I) (- I I)
             (ite B I I)))
